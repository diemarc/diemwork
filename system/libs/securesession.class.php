...
/*
  ...
  Refactored by diemarc.os <diemarc.os@gmail.com> 2015
*/
...
class SecureSession
{
  ...
  public function _Fingerprint()
  {
    ...
    {
      $fingerprint .= filter_input(INPUT_SERVER,'HTTP_USER_AGENT');//$_SERVER['HTTP_USER_AGENT']
;    }
    if ($this->check_ip_blocks)
    {
      ...
      $blocks = explode('.', filter_input(INPUT_SERVER,'REMOTE_ADDR'));
